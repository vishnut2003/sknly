...
import { AdminOrdersChangeOrderStatusApiRequestData } from "@/app/api/admin/ecommerce/orders/change-order-status/route";
...
export default function ChangeOrderStatusElement({
    defaultStatus,
    orderId,
}: {
    orderId: string,
    defaultStatus: IOrderStatus
}) {
    ...
    async function handleSubmit() {
        ...
        setError(null);
        try {
            const requestData: AdminOrdersChangeOrderStatusApiRequestData = {
                orderId,
                status: status as IOrderStatus,
            }

            await axios.post(
                "/api/admin/ecommerce/orders/change-order-status",
                requestData,
            );
