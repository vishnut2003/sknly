...
import TrackOrderForm from "./tracking-form";
    ...
    return (
        <InnerPagesLayout>
            ...
            <DefaultSection
                ...
                className='text-[#451F0F] max-w-5xl! space-y-10'
            >
                <PageContentElement
                    items={
                        [
                ...
                <PageContentElement
                    items={[
                        {
                            type: "p",
                            content: (<b>Unforeseen delays</b>)
                        },
                        {
                            type: "p",
                            content: (
                                <>During peak sale periods, public holidays, or due to factors beyond our control, such as weather or courier disruptions, deliveries may take a little longer than usual. We truly appreciate your patience during these times.</>
                            )
                        },
                        {
                            type: "p",
                            content: (
                                <>
                                    If your order hasn’t reached you within the expected delivery window, feel free to reach out to us at <Link href={"mailto:hello@sknlybeauty.com"}>hello@sknlybeauty.com</Link>, and we will be happy to help.
                                </>
                            )
                        }
                    ]}
